...
class WeigherModule:
	...
	def setModope(self, instance_name, weigher_name: str, modope, presettare=0, data_assigned: Any = None, port_rele=None, skip_take_of_weight_check: bool = False):
		return self.instances[instance_name].setModope(weigher_name=weigher_name, modope=modope, presettare=presettare, data_assigned=data_assigned, port_rele=port_rele, skip_take_of_weight_check=skip_take_of_weight_check)
...
class WeigherInstance:
	...
	def setModope(self, weigher_name: str, modope, presettare=0, data_assigned: Any = None, port_rele=None, skip_take_of_weight_check: bool = False):
		status_modope, error_message = self.nodes[weigher_name].setModope(mod=modope, presettare=presettare, data_assigned=data_assigned, port_rele=port_rele, skip_take_of_weight_check=skip_take_of_weight_check)
