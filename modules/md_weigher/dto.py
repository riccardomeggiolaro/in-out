...
class ChangeSetupWeigherDTO(CustomBaseModel):
	...
	report_on_tare: Optional[bool] = None
	report_on_generic: Optional[bool] = None
	csv_on_in: Optional[bool] = None
	csv_on_out: Optional[bool] = None
	csv_on_tare: Optional[bool] = None
	csv_on_generic: Optional[bool] = None
	printer_name_in: Optional[str] = None
	printer_name_out: Optional[str] = None
	printer_name_tare: Optional[str] = None
	printer_name_generic: Optional[str] = None
	number_of_prints_in: Optional[int] = None
	number_of_prints_out: Optional[int] = None
...
class SetupWeigherDTO(BaseModel):
	...
	report_on_tare: Optional[bool] = True
	report_on_generic: Optional[bool] = True
	csv_on_in: Optional[bool] = True
	csv_on_out: Optional[bool] = True
	csv_on_tare: Optional[bool] = True
	csv_on_generic: Optional[bool] = True
	printer_name_in: Optional[str] = None
	printer_name_out: Optional[str] = None
	printer_name_tare: Optional[str] = None
	printer_name_generic: Optional[str] = None
	number_of_prints_in: Optional[int] = 1
	number_of_prints_out: Optional[int] = 1
