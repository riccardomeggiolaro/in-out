...
class __SetupWeigher(__SetupWeigherConnection):
	...
	def setModope(self, mod: str, presettare: Union[int, float] = 0, data_assigned: Any = None, port_rele: tuple = None, from_callback: bool = False):
		...
		if mod == "OPENRELE":
			...
			if not from_callback and (self.modope_to_execute in self.rele_commands or self.modope in self.rele_commands):
