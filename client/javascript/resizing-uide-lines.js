export function initAligningGuidelines(canvas) {
    ...
    // Utilizzabile sia per moving che per scaling
    function checkAlignmentAndSnap(e, isMoving) {
        ...
        for (var i = canvasObjects.length; i--; ) {
            ...
            // Esempio di un controllo (da completare con tutti gli altri):
            if (isInRange(objectLeft, activeObjectLeft)) {
                ...
                // Se in movimento, sposta l'oggetto
                if (isMoving) {
        ...
        if (isInRange(objectTop + objectHeight / 2, activeObjectTop + activeObjectHeight / 2)) {
            ...
            // Aggiungi qui gli altri controlli di allineamento...
        }
    ...
    // Event listener per il movimento degli oggetti
    canvas.on('object:moving', function(e) {
        checkAlignmentAndSnap(e, true);
    });

    // Event listener per il ridimensionamento degli oggetti
    canvas.on('object:scaling', function(e) {
        checkAlignmentAndSnap(e, false);
    });
