...
Sistema di gestione accessi e pesatura con controllo sbarre automatico, integrato con un sistema esterno di identificazione targhe. La priorità determina l'ordine di servizio in coda quando più prenotazioni hanno la stessa data.
...
3. Il sistema esegue la pesata automatica: attende stabilità, registra il peso, genera report
