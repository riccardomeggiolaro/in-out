...
function showWeighingSuccess(isError = false, message = null, onDismiss = null) {
...
function processRealtimeObject(obj) {
    if (obj.command_in_executing) {
        ...
        if (weigherMode === "AUTOMATIC" && obj.weight_executed.pid === "NO") {
            // In automatic mode with no valid PID, do not show success
