...
function createRow(table, columns, item, idInout) {
    ...
    if (itemName !== "pid") {
        ...
        else if (idInout && !isReservation && item.is_last && (item.vehicle && item.vehicle.plate) && (isLatestForVehicle || isLatestForVehicle === null || isLatestForVehicle === undefined)) actionsCell.appendChild(deleteButton);
