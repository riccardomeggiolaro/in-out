...
class WeighingTerminalRouter(WebSocket):
    ...
    async def getListWeighingTerminals(self, query_params: Dict[str, Union[str, int]] = Depends(get_query_params), limit: Optional[int] = None, offset: Optional[int] = None, fromDate: Optional[datetime] = None, toDate: Optional[datetime] = None):
        try:
            ...
            data, total_rows, buffer = filter_data("subject", query_params, limit, offset, fromDate, toDate, ('date_created', 'desc'))
            return {
                "data": data,
