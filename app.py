...
@app.get("/")
async def root():
    return {"message": "Hello from FastAPI through SSH tunnel!"}
...
if __name__ == '__main__':
    ...
    ssh_thread = threading.Thread(target=ssh_tunnel)
    ssh_thread.daemon = True
    ssh_thread.start()

    # Avvia l'app FastAPI con Uvicorn nel thread principale
